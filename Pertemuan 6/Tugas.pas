...
var
  i, batas: integer; // variabel untuk iterasi dan batas pengecekan
begin
...
begin
  clrscr;
    ...
    writeln;
    // minta user masukkan
    write('Masukkan sebuah bilangan: '); readln(nilai); // membaca input dari user
    
    // Memanggil function IsPrime
    if IsPrime(nilai) then
        writeln(nilai, ' adalah bilangan prima.') // menampilkan output jika bilangan prima
    else
        writeln(nilai, ' bukan bilangan prima.'); // menampilkan output jika bukan bilangan prima
end.